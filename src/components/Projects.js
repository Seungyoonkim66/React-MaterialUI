            ...
            <div className={classes.root}>
                ...
                <TabPanel value={value} index={2} style={{ width: '90%' }}>
                    <ProjectsDesc 
                        ...
                        name='소켓 간 락 전달 비율에 따른 NUMA 기반 락 성능 분석'
                ...
                <TabPanel value={value} index={3} style={{ width: '90%' }}>
                    <ProjectsDesc
                        ...
                        desc2='아래 버튼을 클릭하시면 단일 및 다중 가상머신 환경에서의 NUMA 기반 최적화 락의 FxMark - MWRL 워크로드 성능을 나타내는 그래프를 확인하실 수 있으며, 위에 제공된 링크를 통해 원문을 확인하실 수 있습니다.'
                        img={kcc}
                        btnTitle='experiment result graph'
                        isButtonShown={true}
                    />
                </TabPanel>
                ...
                <TabPanel value={value} index={7} style={{ width: '90%' }}>
                    <ProjectsDesc
                        ...
                        desc2='본 프로젝트에서 R 코드 작성을 하였고, 2019년 동계 R 코딩 캠프 우수상을 수상하였습니다. 구현 코드에 대한 자세한 설명은 위 관련 자료 링크 또는 포트폴리오 pdf에서 확인하실 수 있으며, 아래 버튼을 클릭하시면 채팅 데이터 분석을 통해 <ㅋㅋㅋㅋ> 등장 빈도가 높은 구간을 나타내는 시각 자료를 보실 수 있습니다.'
                        img={TwitchR}
                        btnTitle='data analysis visualization'
                        isButtonShown={true}
                    />
                </TabPanel>
                ...
                <TabPanel value={value} index={9} style={{ width: '90%' }}>
                    <ProjectsDesc
                        ...
                        desc2='Kingo Market은 Django 웹 프레임워크를 사용하여 개발하였고, 본 프로젝트에서 HTML, CSS를 활용하여 프론트엔드를 개발했습니다. 데이터베이스 ER Diagram과 상세한 기능 설명 및 구현 코드는 위 github repository에서 확인해주시기 바랍니다. 또한 아래 버튼을 클릭하시면 사이트의 상품 진열 파트 UI를 확인하실 수 있습니다.'
                        img={kingomarket}
                        btnTitle='component screen capture'
                        isButtonShown={true}
                    />
                </TabPanel>
